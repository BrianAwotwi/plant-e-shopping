...
function ProductList() {
  ...
  //console.log("Number of unique plant types:", uniquePlantTypes);
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    {/* Toggle button based on whether the product is in the cart */}
                    {cart.some((cartItem) => cartItem.name === plant.name) ? (
                      <button className="product-added" disabled>
                        Added to Cart
                      </button>
                    ) : (
                      <button
